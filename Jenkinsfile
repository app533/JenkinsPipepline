   ...
   stage('SonarQube Analysis') {
      steps {
        withSonarQubeEnv('SonarQube') {
          echo "weqwee"
          sh 'sonar-scanner -D"sonar.projectKey=ok21" -D"sonar.sources=./new.javascript" -D"sonar.host.url=http://35.172.231.163:9000" -D"sonar.token=squ_3192faaffc260279af0bf6ae215c84dbf453acb1"'
        }
      }
    }
